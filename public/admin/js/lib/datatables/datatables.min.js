...
(function (h) {
    ...
    function Fa(a) {
        var b = m.defaults.oLanguage,
            c = a.sZeroRecords;
        !a.sEmptyTable && c && "Maaf, Data Tidak Ditemukan.. !" === b.sEmptyTable && F(a, a, "sZeroRecords", "sEmptyTable");
    ...
    function Ka(a, b, c, d) {
        var e = [],
            ...
            m = function (a) {
                if (c === k || c === i)
                    (j = l[i]), (n = h.trim(a.innerHTML)), j && j._bAttrSrc ? (S(j.mData._)(d, n), r(j.mData.sort, a), r(j.mData.type, a), r(j.mData.filter, a)) : q ? (j._setter || (j._setter = S(j.mData)), j._setter(d, n)) : (d[i] = n);
                i++;
            };
        if (f)
            for (; f; ) {
        ...
        if (-1 !== h.inArray(!1, b)) C(a, !1);
            ...
            if (0 !== i.length) {
                ...
                (c = f.sZeroRecords),
                    ...
                    (b[0] = h("<tr/>", { class: e ? d[0] : "" }).append(h("<td />", { valign: "top", colSpan: ba(a), class: a.oClasses.sRowEmpty }).html(c))[0]);
    ...
    function wb(a) {
        ...
        for (g = 0; g < c; g++)
            (n = b[g]),
                ...
                ra.columns.push({ data: i, name: n.sName, searchable: n.bSearchable, orderable: n.bSortable, search: { value: l.sSearch, regex: l.bRegex } }),
                r("mDataProp_" + g, i),
    ...
    function Ha(a) {
        ...
        if (d || (!r && !f && !e && j == ba(a) && j == n.length)) for (m = 0; m < j; m++) (i = $(a, m)), null !== i && (c[i].sWidth = v(n.eq(m).width()));
        else {
            ...
            for (m = 0; m < i.length; m++)
                (p = c[i[m]]),
                    ...
                    p.sWidthOrig && f && h(n[m]).append(h("<div/>").css({ width: p.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
    ...
    var m = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) K(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    var t = o.oClasses;
                    g.bJQueryUI
                        ? (h.extend(t, m.ext.oJUIClasses, g.oClasses), g.sDom === l.sDom && "lfrtip" === l.sDom && (o.sDom = '<"H"lfr>t<"F"ip>'), o.renderer)
    ...
    u.register = p = function (a, b) {
        if (h.isArray(a)) for (var c = 0, d = a.length; c < d; c++) u.register(a[c], b);
        else
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "Maaf, Data Belum Ada.. !",
