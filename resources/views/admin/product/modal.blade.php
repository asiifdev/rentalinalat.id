                                ...
                                <div class="basic-form">
                                    <form action="{{ route('product.add') }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="kode" class="form-control input-rounded"
                                                placeholder="Masukkan Kode Produk" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="stock"><span class="ml-2">Stock</span></label>
                                            <input type="number" name="stock" class="form-control input-rounded"
                                                placeholder="Masukkan Stock Produk" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="description"><span class="ml-2">Deskripsi
                                                    Produk</span></label>
                                            <textarea name="description" id="description" class="form-control" style="height: 200px;"
                                                placeholder="Masukkan Deskripsi"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="dayrate"><span class="ml-2">Harga Produk /
                                                    hari</span></label>
                                            <input type="number" name="dayrate" class="form-control input-rounded"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category_id" id="subcategoryy"
                                                class="form-control input-rounded " required>
                                                <option value="" disabled selected> <span style="color: #453;">--
                                                        Pilih Kategori Induk Terlebih Dahulu --</span> </option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group mt-1">
                                            ...
                                            <input class="form-control input-rounded d-flex" type="file"
                                                id="foto" name="foto" accept=".jpg,.png,.jpeg">
                                        </div>
                                </div>
                            </div>
                        </div>
