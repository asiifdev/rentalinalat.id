...
<head>
    ...
    <style>
        ...
        .bg-img {
            background-image: url('images/bg-langit.jpg');
        ...
        <div class="container py-5 h-100">
            <div class="row d-flex align-items-center justify-content-center h-100">
                <div class="col-md-8 col-lg-7 col-xl-6">
                    {{-- <img src="https://app.svgator.com/assets/svgator.webapp/log-in-girl.svg" class="img-fluid"
                        alt="Phone image"> --}}
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        viewBox="0 0 1000 1000">
                        <defs>
                            <linearGradient id="Dégradé_sans_nom_4" x1="397.3" y1="531.55" x2="398.77"
                                y2="531.55" gradientTransform="matrix(1, 0, 0, -1, 0, 1002)"
                            ...
                            <linearGradient id="Dégradé_sans_nom_11" x1="3093.01" y1="-319.7" x2="3093.01"
                                ...
                                xlink:href="#Dégradé_sans_nom_5" />
                            <linearGradient id="Dégradé_sans_nom_12" x1="56.64" y1="500.45" x2="44.9"
                                y2="595.99" gradientTransform="matrix(1, 0, 0, -1, 0, 1002)"
                                xlink:href="#Dégradé_sans_nom_5" />
                            <linearGradient id="Dégradé_sans_nom_13" x1="64.52" y1="585.05" x2="81.08"
                                y2="592.79" gradientTransform="matrix(1, -0.01, -0.01, -1, -9.3, 1026.18)"
                                xlink:href="#Dégradé_sans_nom_5" />
                            <linearGradient id="Dégradé_sans_nom_14" x1="84.31" y1="585.6" x2="114.29"
                                y2="599.6" gradientTransform="matrix(1, -0.01, -0.01, -1, -9.3, 1026.18)"
                                xlink:href="#Dégradé_sans_nom_5" />
                            ...
                            <linearGradient id="Dégradé_sans_nom_16" x1="3047.49" y1="-280.31" x2="3047.49"
                                ...
                                xlink:href="#Dégradé_sans_nom_5" />
                            <linearGradient id="Dégradé_sans_nom_17" x1="124.16" y1="607.81" x2="154.14"
                                y2="621.82" gradientTransform="matrix(1, -0.01, -0.01, -1, -9.3, 1026.18)"
                                xlink:href="#Dégradé_sans_nom_5" />
                            <linearGradient id="Dégradé_sans_nom_18" x1="144.36" y1="634.38" x2="174.34"
                                y2="648.38" gradientTransform="matrix(1, -0.01, -0.01, -1, -9.3, 1026.18)"
                                xlink:href="#Dégradé_sans_nom_5" />
                            <linearGradient id="Dégradé_sans_nom_19" x1="106.45" y1="579.15" x2="118.92"
                                y2="584.97" gradientTransform="matrix(1, -0.01, -0.01, -1, -9.3, 1026.18)"
                                xlink:href="#Dégradé_sans_nom_5" />
                            ...
                            <linearGradient id="Dégradé_sans_nom_22" x1="3026.76" y1="-464.82" x2="3026.76"
                                ...
                                xlink:href="#Dégradé_sans_nom_5" />
                            <linearGradient id="Dégradé_sans_nom_23" x1="-119.4" y1="924.34" x2="-119.4"
                                y2="984.97" gradientTransform="matrix(0.87, -0.5, 0, -1.15, 832.43, 1691.1)"
                                xlink:href="#Dégradé_sans_nom_5" />
                            <linearGradient id="Dégradé_sans_nom_24" x1="-96.59" y1="903.81" x2="-96.59"
                                y2="991.64" gradientTransform="matrix(0.87, -0.5, 0, -1.15, 832.43, 1691.1)"
                                xlink:href="#Dégradé_sans_nom_5" />
                            ...
                            <linearGradient id="Dégradé_sans_nom_2" x1="443.16" y1="829.82" x2="874.22"
                                y2="437.05" gradientTransform="matrix(1, 0, 0, -1, 0, 1002)"
                                gradientUnits="userSpaceOnUse">
                                <stop offset="0" stop-color="#f5f5f5" stop-opacity="0.7" />
                                <stop offset="1" stop-color="#0d0a3f" stop-opacity="0.3" />
                            </linearGradient>
                            <linearGradient id="Dégradé_sans_nom_3" x1="397.3" y1="635.5" x2="915.3"
                                y2="635.5" gradientTransform="matrix(1, 0, 0, -1, 0, 1002)"
                                gradientUnits="userSpaceOnUse">
                            ...
                            <g id="circuits-2">
                                <g id="blue">
                                    <path
                                        ...
                                        <animate attributeName="stroke-dasharray" dur="20s"
                                            values="80%;120%;80%" repeatCount="indefinite" />
                                    </path>
                                </g>
                                <g id="white">
                                    <path
                ...
                <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1 bg-white p-5 rounded border border-dark">
                    <svg width="100%" height="100%">
                        <text x="50%" y="60%" text-anchor="middle">
                            Rentalinalat.id
                        </text>
                    </svg>
                    <form autocomplete="off" method="POST" action="{{ route('login') }}" class="">
                        @csrf
                        <!-- Email input -->
                        <div class="form-outline mb-4 rounded p-2">
                        ...
                        <!-- Submit button -->
                        <button type="submit" class="btn btn-primary btn-lg btn-block btn-custom">Sign in</button>
                        @if (Route::has('password.request'))
                            <a class="text-dark m-2 mt-5" href="{{ route('password.request') }}">
                        ...
                        <a class="btn btn-primary btn-lg btn-block button-48" style="background-color: #E94235"
