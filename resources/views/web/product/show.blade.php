                            ...
                            <div class="row mt-3 p-2">
                                {{-- <div class="col-lg-6 col-xxl-4 col-xl-6 col-md-6 col-sm-6">
                                    <div class="" id="collapse_tanggal">
                                        <a href="#" data-toggle="collapse" data-target="#collapse_2"
                                            aria-expanded="false" class="btn-nav-accordion">
                                            <i class="icon-control fa fa-chevron-down"></i>
                                            <h6><i class="bi bi-calendar-date me-2"></i> Dari Tanggal</h6>
                                        </a>
                                    </div>
                                ...
                                <div class="col-lg-6 col-xxl-4 col-xl-6 col-md-6 col-sm-6">
                                    <header class="">
                                        <a href="#" data-toggle="collapse" data-target="#collapse_3"
                                            aria-expanded="false" class="btn-nav-accordion" onclick="">
                                            <i class="icon-control fa fa-chevron-down" style="rotate"></i>
                                            <h6><i class="bi bi-calendar-date-fill me-2"></i> Sampai Tanggal
                                            </h6>
                                        </a>
                                    </header>
                                ...
                                <div class="col-lg-6 col-xxl-4 col-xl-6 col-md-6 col-sm-6">
                                    <div class="input-group rounded">
                                        ...
                                        <input type="search" class="form-control rounded border-0 boxSearch forDate" placeholder="Dari Tanggal"
                                            aria-label="Search" aria-describedby="forDate" />
                                    </div>
                                </div>
                                <div class="col-lg-6 col-xxl-4 col-xl-6 col-md-6 col-sm-6">
                                    <div class="input-group rounded">
                                        ...
                                        <input type="search" class="form-control rounded border-0 boxSearch toDate" placeholder="Sampai Tanggal"
                                            aria-label="Search" aria-describedby="toDate" />
                                    </div>
                                </div>
                            </div>
                            {{-- END ROW TANGGAL --}}
